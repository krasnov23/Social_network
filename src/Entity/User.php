...
// Строка ниже отображается при попытка зарегистрироваться с уже имеющимся логином
...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    // Изменяем имя таблицы в которой будут написаны подписчики и подписки
    ...
    public function getRoles(): array
    {
        ...
        // Если пользователь прошел Верификацию ему присваивается роль ROLE_WRITER
        if ($this->isVerified())
        {
            $roles[] = 'ROLE_WRITER';
        }
    ...
    public function getYes(): ?UserProfile
    {
        return $this->yes;
    }

    public function setYes(UserProfile $yes): self
    {
